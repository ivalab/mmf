...
@registry.register_model("resnet_lstm_add")
class ResnetLSTMAdd(BaseModel):
    """ResnetLSTMAdd is a simple model for vision and language tasks. ResnetLSTMAdd is supposed
    ...
    addition. Then, it finally passes the fused representation from a MLP to
    ...
    @classmethod
    def config_path(cls):
        return "configs/models/resnet_lstm_add/defaults.yaml"
    ...
    def forward(self, sample_list):
        ...
        fused = torch.add(text_features, image_features)
