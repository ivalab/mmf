...
@registry.register_model("bert_only")
class BERTOnly(BaseModel):
    """BERTOnly is a simple model with only BERT for language modeling.
    ...
    def config_path(cls):
        ...
        return "configs/models/bert_only/defaults.yaml"
