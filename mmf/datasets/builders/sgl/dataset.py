...
class SGLDataset(MMFDataset):
    ...
    # TOD0: implement, right now set fast_read to be false
    ...
    def load_item(self, idx):
        ...
        if self._use_features:
            ...
            image_path = sample_info["image_name"] + ".png"
    ...
    # TOD0: implement, right now set use_ocr to be false
    ...
    def add_answer_info(self, sample_info, sample):
        if "answers" in sample_info:
            ...
            sample.subject_targets = processed_soft_copy_answers["subject_targets"]
            sample.object_targets = processed_soft_copy_answers["object_targets"]
            sample.state_targets = processed_soft_copy_answers["state_targets"]

            # add empty array for targets to avoid error message
            sample.targets = []
